...
const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 6,
        sql: include_str!("../migrations/0006_reference_sources.sql"),
    },
    Migration {
        version: 7,
        sql: include_str!("../migrations/0007_demo_reference_catalog_v1.sql"),
    },
    Migration {
        version: 8,
        sql: include_str!("../migrations/0008_synthetic_profiles.sql"),
    },
];
