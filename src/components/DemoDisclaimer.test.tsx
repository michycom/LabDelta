...
describe("demo disclaimer", () => {
  it("precedes the application and states the binding demo limitations", () => {
    ...
    expect(screen.queryByText("Dashboard — notable changes")).not.toBeInTheDocument();
    expect(patientApi.listPatients).not.toHaveBeenCalled();
  });

  it("stores only the local UI acknowledgement and keeps the demo marker visible", () => {
